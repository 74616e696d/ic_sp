            ...
            switch(n) {
              ...
              case 'Color':
                if(value == 'Light') {
                  ...
                  this.sidebarLogo.src = 'asset/db/_con/images/logo.png';
                } else {
                  this.sidebarLogo.src = 'asset/db/_con/images/logo-white.png';
                }
                break;
              case 'ShowType':
                if(value == 'Shrink') {
            ...
            switch(n) {
              case 'Color':
                if(value == 'Dark') {
                  ...
                  this.navbarLogo.src = 'asset/db/_con/images/logo-white.png';
                } else {
                  this.navbarLogo.src = 'asset/db/_con/images/logo.png';
                }
                break;
