...
<div class="tab-content">
	<div id="tab1" class="tab-pane active fade in">
		<a href="{{ $base_url }}university/admin/reftext/new_ref_text" data-target='#addReftext' data-toggle='modal'  class="btn btn-success pull-right"><i class="fa fa-plus"></i> New Reference Text</a>
...
<script type="text/javascript">
	...
	$('#btnSaveGroup').click(function(){
		...
		$.ajax({
			url: '{{ $base_url }}university/admin/reftext/add_ref_group',
			type: 'POST',
			data: {group: group}
		})
		.done(function(res) {
	...
	table = $('#tblRefText').DataTable({
		...
		"ajax": {
		    "url": "{{ $base_url }}university/admin/reftext/ref_list_dt",
		    "type": "POST"
		},
...
{
	$.ajax({
		url: '{{ $base_url }}university/admin/reftext/ref_group_table',
		type: 'GET'
	})
	.done(function(res) {
