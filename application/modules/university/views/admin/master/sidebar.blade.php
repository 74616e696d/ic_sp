...
<div class="span3" id="sidebar">
    ...
    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        <li class="active">
            <a href="{{$base_url}}university/admin/dashboard"><i class="icon-chevron-right"></i> Uni Dashboard</a>
        </li>
        <li>
            <a href="{{$base_url}}university/admin/questions/create"><i class="icon-chevron-right"></i>Add Uni Question</a>
        </li>
        <li>
            <a href="{{$base_url}}university/admin/questions"><i class="icon-chevron-right"></i>Uni Question Bank</a>
        </li>

        <li>
            <a href="{{$base_url}}admin/written_ques"><i class="icon-chevron-right"></i>Written Question</a>
        </li>

        <li>
            <a href="{{$base_url}}admin/manage_model_test_ques/question"><i class="icon-chevron-right"></i>Manage Model Test Question</a>
        </li>
         <li>
            <a href="{{$base_url}}admin/study_hints"><i class="icon-chevron-right"></i>Manage Study Hints</a>
        </li>
