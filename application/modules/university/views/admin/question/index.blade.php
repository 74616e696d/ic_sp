...
@section('script')
	...
	$(document).ready(function(){
	    ...
	    action_chapter_group='{{ $base_url }}university/admin/questions/get_chapter';
	    action_chapter='{{ $base_url }}university/admin/questions/get_chapter_group';
	    ...
	    table = $('#qlist').DataTable({
	        ...
	        "ajax": {
	            "url": "{{ $base_url }}university/admin/questions/question_list_dt",
	            "type": "POST"
	        },
	    ...
	    $('#search').click(function(e) {
	        ...
	        var term={id:id,test:test,subject:subject,chapter_group:chapter_group,chapter:chapter,ques:ques};
