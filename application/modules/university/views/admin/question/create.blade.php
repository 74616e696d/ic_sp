...
<fieldset class="form-horizontal input-form">
    ...
    <!-- form start -->
	<form method="post" action="{{ $base_url }}university/admin/questions/store" enctype="multipart/form-data">      
...
$(document).ready(function(){
    ...
    var ddl_exam_cat=$('#ddl_exam_cat'),
        ...
        action_change_subject='<?php echo base_url(); ?>university/admin/questions/get_subjects',
         action_change_prev_exam='<?php echo base_url(); ?>university/admin/questions/get_prev_exam',
        action_change_chapter_group='<?php echo base_url(); ?>university/admin/questions/get_chapter_group',
        action_change_chapter='<?php echo base_url(); ?>university/admin/questions/get_chapter';
       ...
       ddl_exam_cat.change(function(){
       	$eid=$(this).val();
       	$.ajax({
        	url: '<?php echo base_url(); ?>university/admin/questions/get_prev_exam',
        	type: 'POST',
        	data: {eid:$eid},
        })
        .done(function(msg) {
        ...
        editor.on('blur',function(){
            ...
            { 
                $.ajax({
                    url:'<?php echo base_url(); ?>university/admin/questions/find_similar_question',
                    type:'GET',
