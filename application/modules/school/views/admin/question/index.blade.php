...
@section('script')
	...
	$(document).ready(function(){
	    ...
	    action_chapter_group='{{ $base_url }}school/admin/questions/get_chapter';
	    action_chapter='{{ $base_url }}school/admin/questions/get_chapter_group';
	    ...
	    table = $('#qlist').DataTable({
	        ...
	        "ajax": {
	            "url": "{{ $base_url }}school/admin/questions/question_list_dt",
	            "type": "POST"
	        },
