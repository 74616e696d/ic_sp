...
<script type="text/javascript" src="{{$base_url}}asset/js/clipboard.min.js"></script>
<script type="text/javascript">
	$(document).ready(function() {
		     var myDropzone = new Dropzone("div#dropzone", { 
		        url: "{{$base_url}}school/admin/manage_media/send",
		...
		$('.filter li a').click(function(e){
			...
			$.ajax({
				url: '{{ $base_url }}school/admin/manage_media/reload_files',
				type: 'POST',
				data: {term: term}
			})
			.done(function(res) {
