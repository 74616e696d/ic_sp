...
<head>
    <meta charset="utf-8">
    <title>School Admin | Iconpreparation</title>
...
<!--/span-->
<a href="{{ $base_url }}admin/dashboard" class="btn btn-default btn-small"><i class="fa fa-switch"></i>Switch To Main Dashboard</a>
<a href="{{ $base_url }}university/admin/dashboard" class="btn btn-default btn-small"><i class="fa fa-switch"></i>Switch To University Dashboard</a>
...
<hr>
<footer>
    <p>&copy; iconpreparation.com {{date('Y')}}</p>
</footer>
</div>
<!--/.fluid-container-->
