<aside class="left-side sidebar-offcanvas">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active">
                <a href="{{base_url()}}member/cexam/ongoing" style='color:red;font-weight: bold;'>
                <i class="menu-icon fa fa-bolt" style='color:#444;'></i> <span>37th BCS Crash Program</span>
                </a>
            </li>

            
          <!--   <li class="active">
                <a href="{{base_url()}}member/syllabus">
                <i class="menu-icon syllabus"></i> <span>Exam Guideline</span>
                </a>
            </li> -->
            <li><a href="{{base_url()}}member/practice_subject_list" title="Study Materials"><i class="menu-icon practice"></i><span>Read &amp; Practice</span></a></li>
            <li>
             ...
             <li>
              ...
              <li>
                <a href="{{base_url()}}member/on_going_class">
                <i class="menu-icon model"></i> <span>Classes</span>
                </a>
            </li>
              <li>
