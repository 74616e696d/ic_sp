                   ...
                   @include('master.content_header')
                    ...
                    <section class="content">
    		           ...
    		           <div id="result" class="col-sm-6 col-sm-offset-3">
    					<div>
    						<h3>Result Of  {{$result['subject']}}</h3>
    						<a href="#" style='float:left;' class="print"><i class="fa fa-print"></i></a>


    						<a class='btn btn-default btn-xs' style='float:right' href="{{$base_url}}member/subject_quiz_result_details/index/{{$result['qid']}}"><i class="fa fa-eye">&nbsp;&nbsp;View Details</i></a>
    						...
    						<ul class="list-group">
    							...
    							<li class="list-group-item"><strong>Total Question</strong><span>{{$result['total']}}</span></li>
    							...
    							<li class="list-group-item"><strong>Not Answered</strong><span>{{$result['unanswered']}}</span></li>
    							<li class="list-group-item"><strong>You Top Correct Answer</strong><span>{{$result['user_top']}}</span></li>
    							<li class="list-group-item"><strong>Exam Top</strong><span>{{$result['subject_top']}}</span></li>
