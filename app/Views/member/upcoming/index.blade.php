...
<div class="bx">
	<div class="bx-header">
		<div class="bx-title">43rd BCS Crash Program</div>
	</div>
	<div class="bx-body">
		        ...
		        <div class="row">
		            <div class="container">
		                <div class="col-xs-10 col-xs-offset-1">
							<p class="bcs"><b>43rd</b> <b>BCS</b></p>
		                ...
		                <div class="col-xs-10 col-xs-offset-1">
		                	<div class="forty-days">
		                		<div class="forty-days-four">
		                			<p><span>5</span><span class="forty-days-zero">0</span> <span class="forty-days-days">DAYS</span><span class="crash-crash">CRASH PROGRAM</span></p>
		                			<p class="date-absolute-crash">August 31, 2021 - October 20, 2021</p>
		                		</div>
		                	</div>
		                </div>
		            </div>
