...
<div class="bx">
	<div class="bx-header">
		<div class="bx-title">41st BCS Crash Program</div>
	</div>
	<div class="bx-body">
		        ...
		        <div class="row">
		            <div class="container">
		                <div class="col-xs-10 col-xs-offset-1">
							<p class="bcs"><b>41</b><sup>st</sup> <b>BCS</b></p>
							<p class="text-bcs"><b>IF YOU</b> HAVE NOT STARTED YOUR PREPARATION, <b>IT&#8217;S TIME<br/></b> &amp; <b>IT&#8217;S THE LAST TIME.</b></p>
							<p class="text-bcs">JOIN OUR <b>CRASH PROGRAM</b> &amp; <b>GET READY</b> FOR THE TEST.</p>
		                </div>
		                <div class="col-xs-10 col-xs-offset-1">
		                	<div class="forty-days">
		                		<div class="forty-days-four">
		                			<p><span>8</span><span class="forty-days-zero">0</span> <span class="forty-days-days">DAYS</span><span class="crash-crash">CRASH PROGRAM</span></p>
		                			<p class="date-absolute-crash">November 1, 2019 - January 10, 2020</p>
		                		</div>
		                	</div>
		                </div>
		            </div>
		...
		@endif
			...
			<?php $tags=roadmap_details_model::chapter_tag($row->id); ?>
				<tr>
					...
					@if($tags)
					@foreach($tags as $tag)
					<a href='{{ $base_url }}member/cexam/details/{{ $tag->id }}' target='_blank' class="label label-default">{{ $tag->name }}</a>
					@endforeach
					@endif
					</td>
					<td>
