@extends('front_layout.master_exam')
...
<div class="col-sm-12 col-xs-12 visible-xs visible-sm toolbar-mobile">
  ...
  <div class="pull-left"><h4><?php if($chapter_name)echo ref_text_model::get_text($chapter_name); ?></h4>
    ...
    <section class="row top-buffer">
      <div id='left-portion' class="col-lg-4 col-md-4 col-sm-10 col-xs-10">
        <div id="sidebar" role="navigation">
          <div class="well sidebar-nav">
            <h2 class="hidden-sm hidden-xs title tutorial-color"><?php if($chapter_name)echo ref_text_model::get_text($chapter_name); ?></h2>
     ...
     <!--  <hr/> -->
        <div class="jumbotron">
          ...
          <div>
            <button type='button' disabled="disabled" class='btn btn-primary btn-mini'>Report This Question<span 
            title='If you think something wrong with this question,please report'>(*)</span></button>

            <button type='button' disabled="disabled" class='btn btn-info btn-mini'>Add to review list<span title='Add this question to list for future review'>(*)</span></button>
...
<script type='text/javascript'>
  var store_ans_url='',
  finish_action='',
  redirect_url='{{ $base_url }}sample_exam/show_result',
  report_action='',
  review_action='',
  get_mrk_ques_action='',
  get_all_ques_action='';
...
<script type="text/javascript" src='{{$base_url}}asset/frontend/js/sample_quiz.js'></script>
<script type="text/javascript">
...
function showAns(qid, sl, test_name) {
  ...
  $.ajax({
      url: '{{$base_url}}sample_exam/get_ans',
      type: 'GET',
      data: {
        qid: qid,
        sl: sl,
