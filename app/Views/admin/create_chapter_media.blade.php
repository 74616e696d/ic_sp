...
@section('content')
<form action="{{$base_url}}admin/chapter_media/store" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea type="text" name="txt_media" id="txt_media" required='required'></textarea>
		</div>
	</div>
	...
	<div class="control-group">
		<div class="controls">
			<label><input style='float:left' type="checkbox" value="1" name="ck_display" id="ck_display">&nbsp;&nbsp;Display</label>
		</div>
	</div>
	<div class="control-group">
		<div class="controls">
