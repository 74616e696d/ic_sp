...
@section('content')
<form method="post" action="{{ $base_url }}admin/company_info/store" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="txt_web" id="txt_web">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="txt_logo" id="txt_logo">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="checkbox" name="ck_active" id="ck_active" value="1">
		</div>
	</div>
	<div class="control-group">
