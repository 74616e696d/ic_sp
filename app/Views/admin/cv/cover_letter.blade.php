<form class="form-horizontal" action="{{$base_url}}admin/cvtemp/upload_cover_letter" enctype="multipart/form-data" method="post">
	<input type="hidden" name="hdn_id"  value="{{ $cv->id }}">
	<div class="control-group div_fl">
		<label for="userfile" class="control-label">Cover Letter </label>
		<div class="controls">
			<input type="file" name="userfile" id="userfile">
		</div>
	</div>
	<div class="control-group external">
		<label for="link" class="control-label">Cover Letter </label>
		<div class="controls">
