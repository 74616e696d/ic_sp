        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-justified nav-tabs" role="tablist">
                <li role="presentation" class="active">
                    <a href="#bcs"  role="tab" data-toggle="tab">BCS</a>
                </li>
                <li role="presentation">
                    <a href="#bank" role="tab" data-toggle="tab">BANK</a>
                </li>
                <li role="presentation">
                    <a href="#govt" role="tab" data-toggle="tab">GOVT. JOB</a>
                </li>
                <li role="presentation">
                    <a href="#teacher"  role="tab" data-toggle="tab">TEACHER'S REG</a>
                </li>
                <li role="presentation">
                    <a href="#mba" role="tab" data-toggle="tab">MBA</a>
                </li>
            </ul>
                ...
                <div role="tabpanel" class="tab-pane active" id="bcs">
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 no-pad-left">
                        ...
                        <div class='pull-left'>
                            ...
                            <li><h3>Study Material</h3></li>
                                ...
                                <?php 
                                  $bcs_slug=$ci->slug->create_slug($row->name);
                                  $bcs_id='7';
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        <ul class='list-unstyled'>
                            ...
                            <?php 
                              ...
                              if($is_auth)
                              {
                                $lnk_bcs="{$base_url}member/practice_test/index/{$row->id}/{$bcs_exam_slug}";
                              } 
                            ?>
                            <li><a href="{{$lnk_bcs}}">{{$row->name}}</a></li>
                            @endforeach
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        <ul class="list-unstyled">
                          ...
                          <li>
                             @if($next_bcs_exam)
                             <img src="{{$base_url}}asset/upload/{{$next_bcs_exam->fall_back_img}}" alt="">
                            @endif
                          </li>
                        </ul>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="bank">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                      <ul class="list-unstyled">
                        ...
                        <li>
                           @if($next_bank_exam)
                           <img src="{{$base_url}}asset/upload/{{$next_bank_exam->fall_back_img}}" alt="">
                          @endif
                        </li>
                      </ul>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="govt">
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <ul class="list-unstyled">
                      ...
                      <li>
                         @if($next_govt_exam)
                         <img src="{{$base_url}}asset/upload/{{$next_govt_exam->fall_back_img}}" alt="">
                        @endif
                      </li>
                    </ul>
                 </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                      <ul class="list-unstyled">
                        ...
                        <li>
                           ...
                           <img src="{{$base_url}}asset/upload/{{$next_teachers_exam->fall_back_img}}" alt="">
                          @endif
                        </li>
                      </ul>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="mba">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                      <ul class="list-unstyled">
                        ...
                        <li>
                           @if($next_mba_exam)
                           <img src="{{$base_url}}asset/upload/{{$next_mba_exam->fall_back_img}}" alt="">
                          @endif
                        </li>
                      </ul>
                    </div>
