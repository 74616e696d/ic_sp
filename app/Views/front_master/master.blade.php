...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Best website for BCS Exam and best website for Bank Job Preparation. All BCS starting from 10th to 40th Questions and solutions are available here. BCS Model Tests, Bank Job Model Tests are available here. You will get last 10 years bank job questions. Special Arrangements for 41st BCS Preliminary." />
        <meta name="keyword" content="40 BCS, 40th BCS, All BCS questions and solutions, 35th BCS questions and solutions, Bank questions and solutions, Bank jobs in Bangladesh, Bangladesh Bank AD questions and solutions, Bangladesh Bank job questions, Bank job questions, BCS written, Android app for Bank job, Android App for BCS, Current Affairs, Exim Bank questions and solutions, Agrani Bank Questions 2015, Trust Bank Questions, Sonali Bank Questions and Solutions, General Knowledge for BCS, Computer Questions for Bank Jobs, Puabli Bank Questions and Solutions, Krishi Bank Questions and Solutions, Bank Job questions, BCS Model Test" />
        ...
        <?php 
          ...
          $default_meta.='<meta property="og:title" content="BCS &amp; Bank Job Preparation" />'."\r\n";
          $default_meta.='<meta property="og:type" content="article" />'."\r\n";
          $default_meta.='<meta property="og:description" content="BCS &amp; Bank Job Preparation provided by Iconpreparation. Best website for BCS Exam and best website for Bank Job Preparation. All BCS starting from 10th to 37th Questions and solutions are available here. People can study all materials and take model tests for BCS &amp; Bank Job Preparation. Banks job questions and solutions are also available here. Expert instructors are there to support the candidates to make an excellent preparation for job." />'."\r\n";

          $default_meta.='<meta property="og:image" content="'. base_url('asset/frontend/new/img/facebook.jpg') . '" />'."\r\n";
        ?>
