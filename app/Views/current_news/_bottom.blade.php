...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
            ...
            <?php $sports_slug=$slug->create_slug($row->title,1); ?>
                <div class="row ">
                    <div class="bsdo_8">
                        <div class="bdr">
                            <div class="row">
                                <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                    <div class="m_h">
                                        ...
                                        <?php
                                            $img_sports=base_url().'/public/asset/news/'.$row->feature_img;
                                            if(file_exists('/public/asset/news/'.$row->feature_img))
                                            {
                                                $img_sports=base_url().'/public/asset/news/'.$row->feature_img;
                                            }
                                        ?>
                                        ...
                                        <p><a href="{{base_url()}}news/details/{{$sports_slug}}/{{$row->id}}"><?php echo word_limiter($striped_desc_sports,35,'...'); ?></a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row date_category">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 c">
                                    ...
                                    $category_sports=$slug->create_slug($category,1); 
                                    ?>
          ...
          <!--  END SPORTS -->
            ...
            <?php $awards_slug=$slug->create_slug($row->title,1); ?>
                <div class="row ">
                    <div class="bsdo_8">
                        <div class="bdr">
                            <div class="row news-content">
                                <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                    <div class="m_h">
                                        ...
                                        <p><a href="{{base_url()}}news/details/{{$awards_slug}}/{{$row->id}}"><?php echo word_limiter($striped_desc_awards,35,'...'); ?></a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row date_category">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 c">
                                    ...
                                    <?php 
                                    $category=$currentNewsCategoryModel->get_text($row->category_id);
                                    $category_awards=$slug->create_slug($category,1); 
                                    ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 d">
                                    <p><span class="date">
                                    <i class="fa fa-calendar"></i><?php echo date_short($row->post_date); ?></span>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 space ">
            <div class="bsdo_10">
                ...
                <?php $business_slug=$slug->create_slug($row->title,1); ?>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="pa_la_height">
                                ...
                                <p><a href="{{base_url()}}news/details/{{$business_slug}}/{{$row->id}}">
                                 <?php echo word_limiter($striped_desc_business,35,'..'); ?>
                                </a></p>
                            </div>
                        </div>
                    </div>
                    <div class="row date_category">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 c">
                            ...
                            $category_business=$slug->create_slug($category,1); 
                            ?>
        ...
        @foreach($science as $row)
         <?php $science_slug=$slug->create_slug($row->title,1); ?>
            <div class="row ">
                <div class="bsdo_11">
                    <div class="bdr">
                        <div class="row news-content">
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="m_h">
                                    ...
                                    <?php
                                        ...
                                        {
                                            $img_science=base_url().'/public/asset/news/small/'.$row->feature_img;
                                        }
                                    ?>
                                    ...
                                    <p><a href="{{base_url()}}news/details/{{$science_slug}}/{{$row->id}}"><?php echo word_limiter($striped_desc_science,35,'..'); ?></a></p>
                                </div>
                            </div>
                        </div>
                        <div class="row date_category">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 c">
                                ...
                                <?php 
                                $category=current_news_category_model::get_text($row->category_id);
                                $category_science=$slug->create_slug($category,1); 
                                ?>
       ...
       <!-- END SCIENCE -->
        ...
        @foreach($summits as $row)
         <?php $summits_slug=$slug->create_slug($row->title,1); ?>
            <div class="row ">
                <div class="bsdo_11">
                    <div class="bdr">
                        <div class="row news-content">
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="m_h">
                                    ...
                                    <div class=" hover01 column">
                                    <?php
                                        $img_summits=base_url().'/public/asset/news/'.$row->feature_img;
                                        if(file_exists('/public/asset/news/'.$row->feature_img))
                                        {
                                            $img_summits=base_url().'/public/asset/news/'.$row->feature_img;
                                        }
                                    ...
                                    <p><a href="{{base_url()}}news/details/{{$summits_slug}}/{{$row->id}}"><?php echo word_limiter($striped_desc_summits,35,'..'); ?></a></p>
                                </div>
                            </div>
                        </div>
                        <div class="row date_category">
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-6 c">
                                ...
                                <?php 
                                $category=$currentNewsCategoryModel->get_text($row->category_id);
                                $category_summits=$slug->create_slug($category,1); 
                                ?>
