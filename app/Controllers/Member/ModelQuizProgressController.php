...
use App\Models\Model_quiz_model;
use App\Models\Model_quiz_summery_model;
use App\Models\Model_test_question_model;
use App\Models\Question_bank_model;
use App\Models\Expert_reply_model;


class ModelQuizProgressController extends MemberController {
	...
	function __construct()
	{
		...
		$this->load->model('expert_reply_model');*/
            ...
            $this->model_quiz_summery_model = new Model_quiz_summery_model();
            $this->model_quiz_model = new Model_quiz_model();
	...
	function index()
	{
		...
		//$this->load->blade('member.model_quiz_progress', $data);
                ...
                return $this->render('member.model_quiz_progress', $data);
	}
