...
use App\Models\member\Mistake_model;

class MistakeListController extends BaseController {
	...
	function __construct()
	{
        ...
        if(!$this->userid)
        {
            ...
            $this->mistake = new Mistake_model();
	...
	public function index()
	{
		...
		// $this->load->view('layout/layout', $data);
                return $this->render('member.mistake_list', $data);
