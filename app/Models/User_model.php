...
use App\Models\upgradeRequestModel;
use App\Models\User_detail_model;
...
class User_model extends Model {
	...
	function __construct()
	{
		parent::__construct();
                ...
                $this->upgradeRequestModel = new upgradeRequestModel();
                $this->userDetailsModel = new User_detail_model();
	...
	function add_reg_member($data1,$data2,$data3)
	{
		//$this->db->trans_start();
			...
			$data2['user_id']=$uid;
			$data3['user_id']=$uid;
			$this->upgradeRequestModel->insert($data2);
			$this->userDetailsModel->insert($data3);
	...
	{
		//$ci =& get_instance();
		return $this->database->table('users')->where('email',$email)
		->select('id')
		->get()->getRowArray();
		/*if($q->num_rows()>0)
		{
