 ...
 * Total Functions :
 */
class Question_bank_model extends Model {
    ...
    {
        $sql="select id, question, options,subject,hints,has_paragraph,is_changeable,created_at,updated_at from question_bank where chapter={$chapter} order by id desc";
        //echo $sql;
        $this->db->cache_on();
        $qry=$this->db->query($sql);
